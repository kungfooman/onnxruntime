...
/**
 *
 * @param {number[]} workPerThread
 * @param {[number, number, number]} workgroupSize
 * @param {boolean} transposeA
 * @param {number} tileInner
 * @param {boolean} splitK
 * @param {number} splitedDimInner
 * @param {boolean} isVectorA
 * @returns {string}
 */
export const makeMatMulPackedVec4Source =
    (workPerThread, workgroupSize, transposeA = false, tileInner = 32,
     splitK = false, splitedDimInner = 32, isVectorA = false) => {
...
export const makeMatMulPackedSource = (
  workPerThread, workgroupSize, transposeA = false, tileInner = 32,
  splitK = false, splitedDimInner = 32, sequentialAccessByThreads = false
) => {
