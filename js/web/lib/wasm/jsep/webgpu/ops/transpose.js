...
import {/*ComputeContext,*/ GpuDataType/*, ProgramInfo*/} from '../types.js';
 ...
 * @param {number[]} permAttr
 * @returns {ProgramInfo}
 */
export const createTransposeProgramInfo = (input, permAttr) => {
 ...
 * @param {TransposeAttributes} attributes
 */
export const transpose = (context, attributes) => {
 ...
 * @returns {TransposeAttributes}
 */
export const parseTransposeAttributes = (attributes) =>
