 ...
 */
const createConcatProgramMetadata = (inputCount, cacheHint) =>
    ({name: 'Concat', inputTypes: Array(inputCount).fill(GpuDataType.default), cacheHint});

/**
 *
 * @param {number} numberOfTensors
 * @returns {string}
 */
...
/**
 * @param {readonly IndicesHelper[]} indicesHelper
...
const createConcatProgramInfo =
    (metadata, inputs, axis, dataType = 'f32') => {
...
/**
 * @param {readonly TensorView[]} inputs
 * @param {ConcatAttributes} attributes
 ...
 * @param {ConcatAttributes} attributes
 */
export const concat = (context, attributes) => {
